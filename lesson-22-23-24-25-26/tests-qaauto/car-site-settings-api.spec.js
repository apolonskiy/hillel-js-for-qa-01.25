  ...
  test('API REQUESTS: Can Update currency, units and assert on invalid Change Email or Password actions',
    {
      ...
      console.log(await updateCurrency.json());
      console.log(await updateDistance.json());
      ...
      console.log(await updateCurrencyTest.json());
      console.log(await updateDistanceTest.json());
